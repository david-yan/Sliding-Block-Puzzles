...
public final class StdDrawPlus implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    public static final Color LIGHT_BROWN = new Color(228, 156, 33);
    public static final Color DARK_BROWN = new Color(132, 79, 0);
    ...
    // default font
    private static final Font DEFAULT_FONT = new Font("SansSerif", Font.PLAIN, 26);
